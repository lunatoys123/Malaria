        ...
        validationSchema: Yup.object().shape({
            ...
            Previous_Diagnosis_Malaria: Yup.object().shape({
                ...
                Previously_Diagnosis: Yup.object().when("Diagnosed_Malaria_previous",{
                    is: () => {
                        const Diagnosed_Malaria_previous = _.get(formik.values,'Previous_Diagnosis_Malaria.Diagnosed_Malaria_previous');
                        const Previously_Diagnosis = _.get(formik.values,'Previous_Diagnosis_Malaria.Previously_Diagnosis');
        ...
        <ScrollView nestedScrollEnabled={true}
            ...
            <Center>
                ...
                <Card_Component heading={"Previous Diagnosis Malaria"}>
                    ...
                    {_.get(formik.values,"Previous_Diagnosis_Malaria.Diagnosed_Malaria_previous") == "Yes" ?
                        (
                        <>
                            <FormSigleSelect
                ...
                >
                    <Text ml={2} color="white">Travel History</Text>
                </Button>
            </Center>
        </ScrollView>
    )
