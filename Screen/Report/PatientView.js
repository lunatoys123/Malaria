    ...
    return (
        <Center>
            {Data && Data.map((d, index)=>(
                <Box border="1" borderRadius="md" bg="white" mt="3" w="90%" p="3" shadow="3" key={index}>
                            ...
                            <VStack>
                                <HStack>
                                    <Box borderWidth="1" borderColor="muted.200" w="30%">
                                        <Text bold alignSelf="center">Age</Text>
                                    </Box>
                                ...
                                <HStack>
                                    <Box borderWidth="1" borderColor="muted.200" w="30%">
                                        <Text bold alignSelf="center">Email</Text>
                                    </Box>
                                    <Box borderWidth="1" borderColor="muted.200" w="70%"> 
                                ...
                                <HStack>
                                    <Box borderWidth="1" borderColor="muted.200" w="30%">
                                        <Text bold alignSelf="center">Phone</Text>
                                    </Box>
                                    <Box borderWidth="1" borderColor="muted.200" w="70%"> 
